...
class AdminUserController extends Controller
{
    private $rules = [
        ...
        'image' => 'nullable|file|mimes:jpg,png,webp,svg,jpeg|dimensions:max_width=600,max_height=600',
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('sediadministrador.users.create')->with('success', 'User has been created.');
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        return redirect()->route('sediadministrador.users.edit', $user)->with('success', 'User has been updated.');
    }
    ...
    public function destroy(User $user)
    {
        ...
        $user->delete();
        return redirect()->route('sediadministrador.users.index')->with('success', 'User has been deleted.');
    }
}
