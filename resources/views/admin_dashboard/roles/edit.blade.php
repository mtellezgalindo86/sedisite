    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form action="{{ route('sediadministrador.roles.update', $role) }}" method='post'>
                    @csrf
                    @method('PATCH')
                ...
                <form id='delete_role_{{ $role->id }}' method='post' action="{{ route('sediadministrador.roles.destroy', $role) }}">
                    @csrf
                    @method('DELETE')
                </form>
