        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="who-we-are-content">
                    <h2> <label class="newtitle">Perfil de egresado</label></h2>

                    <p class="text-justify text-blue-sedi">
                        Un niño egresado de <strong>SEDI</strong>:
                        <ul class="text-blue-sedi">
                            ...
                            <li>
                                <strong>Es seguro, responsable y autónomo</strong>
                            </li>
                            <li>
                                <strong>Cuenta con un amplio repertorio de competencias que le apoyan en su desempeño académico presente y futuro</strong>
                            </li>
                        </ul>
                    </p>
            ...
            <div class="col-lg-6">
                <div class="who-we-are-image-wrap">
                    <img src="assets/img/who-we-are/afterschool.jpg" alt="image">
                </div>
            </div>
        </div>
    </div>
