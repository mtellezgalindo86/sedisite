        ...
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('sediadministrador.users.update', $user) }}" method='post' enctype='multipart/form-data'>
                        @csrf
                        @method('PATCH')
                                        ...
                                        <div class='row'>
                                            ...
                                            <div class='col-md-4'>
                                                <div class='user-image'>
                                                    <img width="100%" src="{{ $user->image ? asset('storage/' . $user->image->path) : asset('storage/placeholders/user_placeholder.jpg') }}" alt="">
                                                </div>
                                            </div>
                                        </div>

                                        <div class="mb-3">
                                            <label for="inputProductTitle" class="form-label">Rol de usuario</label>
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="rounded">
                                                        <div class="mb-3">
                    ...
                    <form id='delete_user_{{ $user->id }}' action="{{ route('sediadministrador.users.destroy', $user) }}" method='POST'>@csrf @method('DELETE')</form>
